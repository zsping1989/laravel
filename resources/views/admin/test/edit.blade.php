...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary" ng-controller="admin-test-editCtrl">
                <div class="box-header">
                    <h3 class="box-title" ng-if="row.id">修改测试</h3>
                    <h3 class="box-title" ng-if="!row.id">新增测试</h3>
                    <div class="box-tools">
                ...
                <div class="box-body">
                    <form role="form"  action="/admin/test/edit" method="post" ng-init="data_url='/admin/test/edit/'+row['id'];edit_url='/admin/test/edit';back_url='/admin/test/index'">
                                                                                                                                                                    <div class="form-group row"  ng-init="errorFieldMap['name']='测试名称'">
                                    <div class="col-xs-2">
                                        <label class="pull-right">测试名称:</label>
                                    </div>
                                    <div class="col-xs-3">
                                    ...
                                    <div class="col-xs-3">
                                        <textarea name="description" ng-model="row['description']" class="form-control">@{{row['description']}}</textarea>
                                    </div>
                                    <div class="col-xs-7" ng-if="!error.description">
                                        <span  class="label-msg">填写提示信息!</span>
                                    </div>
                                    <div class="col-xs-7 error-msg" ng-if="error.description">
                                        <span class="label-msg" ng-repeat="info in error.description">@{{info}}</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xs-3">
                                        <input type="text" name="parent_id" ng-model="row['parent_id']" class="form-control">
                                    </div>
