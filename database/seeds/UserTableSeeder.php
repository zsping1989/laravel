...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admin_users')->truncate(); //后台用户表
        DB::table('admin_user_role')->truncate(); //角色关联表
        //创建一个超级管理员用户
        ...
        $superUser->save(); //创建用户
        $superUser->adminUser() //访问关联
         ->save(factory(App\Models\AdminUser::class)->make()) //创建关联后台用户
