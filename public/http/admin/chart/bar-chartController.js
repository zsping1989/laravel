define(['app',
        ...
        'admin/public/headerController',
        'admin/public/leftController'],
        function (app,datas,dataMap,echarts, defaultTheme) {
        app.register.controller('admin-chart-bar-chartCtrl', ["$scope",'$rootScope', 'Model','View','$alert', function ($scope,$rootScope,Model,View,$alert) {
